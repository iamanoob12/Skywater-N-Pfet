...
def main() -> None:
    ...
    files = sorted(base_dir.glob("pmos_gm_vgs_vds_*.csv"))
    if not files:
        raise FileNotFoundError("No PMOS gm CSV files found in the gm folder")
    ...
    ax.set_title("PMOS gm vs V-sweep")
    ...
    output_path = base_dir / "pmos_gm_curves.png"
